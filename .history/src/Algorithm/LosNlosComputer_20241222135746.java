    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < routePoints.size(); i++) {
            ...
            if (losCount == 6 && nlosCount == 2) {
                ...
                System.out.println("Point coordinates (from original route): " + currentPoint);
                ...
                if (!foundFirstPoint) {
                    ...
                    try (FileWriter writer = new FileWriter(outputKMLPath)) {
                        ...
                        writer.write("    <name>Found Point with 6 LOS, 2 NLOS</name>\n");
                        ...
                        writer.write("      <LineStyle><color>ff0000ff</color><width>2</width></LineStyle>\n");
                        writer.write("    </Style>\n");
                        writer.write("    <Style id=\"pointStyle\">\n");
                        writer.write("      <IconStyle>\n");
                        writer.write("        <Icon><href>http://maps.google.com/mapfiles/kml/paddle/red-circle.png</href></Icon>\n");
                        writer.write("      </IconStyle>\n");
                        writer.write("    </Style>\n");
                        
                        // Write the original point
                        writer.write("    <Placemark>\n");
                        writer.write("      <name>Found Point (6 LOS, 2 NLOS)</name>\n");
                        writer.write("      <styleUrl>#pointStyle</styleUrl>\n");
                        writer.write("      <Point>\n");
                        ...
                        for (int j = 0; j < satellites.size(); j++) {
                            ...
                            // Use original point coordinates for the line start
                            writer.write("          " + currentPoint.getY() + "," + currentPoint.getX() + "," + currentPoint.getZ() + "\n");
                            // Convert satellite position back to LAT/LON if needed
